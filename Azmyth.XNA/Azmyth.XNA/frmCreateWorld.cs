...
namespace Azmyth.XNA
{
    ...
    public class frmCreateWorld : XGControl
    {
            ...
            : base(new Rectangle(0, 0, 300, 300), true)
        {
            ...
            lblCharacteristics = new XGLabel(new Rectangle(20, 90, 150, 30), "Terrain Characteristics");
            sldContinentSize = new XGLabeledSlider(new Rectangle(20, 140, 425, 30), 150, "Continent Size", 2, ((0.1f-m_world.ContinentSize) * 100), 0, 10);

            sldCoastLine = new XGLabeledSlider(new Rectangle(20, 190, 425, 30), 150, "Coast Line", 2, m_world.CoastLine, m_world.TerrainHeight * -1, m_world.TerrainHeight);
            sldShoreLine = new XGLabeledSlider(new Rectangle(20, 240, 425, 30), 150, "Shore Line", 2, m_world.ShoreLine * 100, 1, 100);
            sldTreeLine = new XGLabeledSlider(new Rectangle(20, 290, 425, 30), 150, "Tree Line", 2, m_world.TreeLine * 100, 2, 100);
