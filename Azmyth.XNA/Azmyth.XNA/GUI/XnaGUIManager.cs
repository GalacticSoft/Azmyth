...
namespace XnaGUILib
{
    public static class XnaGUIManager
    {
        ...
        public static void Update(GameTime gameTime)
        {
            ...
            if (InputManager.ThumbUpPressed(PlayerIndex.One, ThumbSticks.Left) || InputManager.ThumbLeftPressed(PlayerIndex.One, ThumbSticks.Left))
            {
                if (Controls.Count > 0)
                {
                    ActivatePrevious();
            ...
            if (InputManager.ThumbDownPressed(PlayerIndex.One, ThumbSticks.Left) || InputManager.ThumbRightPressed(PlayerIndex.One, ThumbSticks.Left))
            {
                if (Controls.Count > 0)
                {
                    ActivateNext();
                    //InputManager.SetVibration(PlayerIndex.One, 20f, 20f);
                }
            }
