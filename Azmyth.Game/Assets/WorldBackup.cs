...
//{
//    [Serializable]
//    public class WorldBackup : Asset
//    {
//        private INoise m_terrain;
//        private INoise m_forest;
//        private INoise m_rivers;
//        private INoise m_stones;
//        private INoise m_lava;
//        private INoise m_tempurature;
//        private INoise m_rocks;
//        private INoise m_randomForest;
//        private INoise m_city;
...
//            m_terrain = new SimplexValueSplineNoise(m_persistance, m_frequency, m_terrainHeight, m_octaves, m_seed);
//            m_forest = new SimplexValueSplineNoise(m_persistance, m_frequency, m_terrainHeight, 4, m_seed >> 2);
//            m_rivers = new SimplexValueSplineNoise(m_persistance, .02, m_terrainHeight, 2, (m_seed / 5) * 3);
//            m_stones = new SimplexValueSplineNoise(m_persistance, .02, 1, 5, (m_seed / 3) * 7);
//            m_lava = new SimplexValueSplineNoise(m_persistance, m_frequency, 1, 5, (m_seed / 5) * 3);

//            m_tempurature = new SimplexValueSplineNoise(m_persistance, m_frequency, 40, m_octaves, (m_seed / 9) * 5);
//        }
//    }
//}
